...
ActiveRecord::Base.transaction do
  # Create role admin
  admin = User.create!(email: 'tdphat.study@gmail.com', password: '662001', confirmed_at: Time.current)
  admin.delete_roles
...
# Create medical resources
  ...
  clinic_profiles.each do |clinic_profile|
    ...
    clinic_specification_profile.certificate.attach(io: File.open(Rails.root.join('db/images/default.jpg')), filename: 'default.jpg')
    clinic_specification_profile.clinic_view.attach(io: File.open(Rails.root.join('db/images/default.jpg')), filename: 'default.jpg')
  ...
  clinic_specification_profiles.each do |clinic_specification_profile|
    5.times do
      ...
      service.save!
      consumption = Consumption.create!(service_id: service.id, medical_resource_id: medical_resources[0].id, amount: Faker::Number.within(range: 1..5))
  ...
  def create_booking(hour, service, medical_resource,patient_specification_profile, clinic_specification_profile, status)
    ...
    service_item = ServiceItem.create!(medical_record_id: medical_record.id, service_id: service.id, price: service.price)
    prescription = PrescriptionItem.create!(medical_record_id: medical_record.id, medical_resource_id: medical_resource.medical_resource_id, amount: Faker::Number.within(range: 1..10), price: medical_resource.price)
  end

  clinic_specification_profiles.each do |clinic_specification_profile|
    create_booking(5, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile, clinic_specification_profile, 'finish')
    create_booking(5, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile1, clinic_specification_profile, "payment")
    create_booking(6, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile, clinic_specification_profile, 'finish')
    create_booking(6, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile1, clinic_specification_profile, "payment")
    create_booking(7, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile, clinic_specification_profile, 'finish')
    create_booking(7, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile1, clinic_specification_profile, "appointment")
    create_booking(8, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile, clinic_specification_profile, 'finish')
    create_booking(8, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile1, clinic_specification_profile, "appointment")
    create_booking(9, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile, clinic_specification_profile, 'finish')
    create_booking(9, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile1, clinic_specification_profile, "appointment")
    create_booking(10, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile, clinic_specification_profile, 'finish')
    create_booking(10, clinic_specification_profile.services[0], clinic_specification_profile.inventories[0], patient_specification_profile1, clinic_specification_profile, "appointment")
  end
